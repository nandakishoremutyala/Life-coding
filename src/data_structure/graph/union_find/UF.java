...
public class UF {
    ...
    public static void main(String[] args) {
          ...
          /* Let us create following data_structure.graph
         0
        |  \
        |    \
        1-----2 */
        ...
        if (graph.isCycle(graph) == 1)
            System.out.println("data_structure.graph contains cycle");
        else
            System.out.println("data_structure.graph doesn't contain cycle");
    }
}
