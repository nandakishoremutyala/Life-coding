...
public class MST {
    static class Graph {
        ...
        public void KruskalMST() {
            ...
            // weight.  If we are not allowed to change the given data_structure.graph, we
    ...
    public static void main(String[] args) {
        /* Let us create following weighted data_structure.graph
                 10
            0--------1
            |  \     |
           6|   5\   |15
            ...
            2--------3
                4       */
        int V = 4;  // Number of vertices in data_structure.graph
        int E = 5;  // Number of edges in data_structure.graph
